...
RUN apt-get update && \
    ...
    mv /tmp/install/SiaPrime-v1.4.0-RC5-ea1b5280-debug-contracthack-linux-amd64/spc /usr/local/bin/ && \
    mv /tmp/install/SiaPrime-v1.4.0-RC5-ea1b5280-debug-contracthack-linux-amd64/spd /usr/local/bin/ && \
